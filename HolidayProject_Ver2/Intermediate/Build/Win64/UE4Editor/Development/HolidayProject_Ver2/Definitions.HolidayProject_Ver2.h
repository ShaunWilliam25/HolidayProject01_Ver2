...
#define ORIGINAL_FILE_NAME "UE4Editor-HolidayProject_Ver2.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME HolidayProject_Ver2
...
#define HOLIDAYPROJECT_VER2_API DLLEXPORT
